...
OpenSCADGraphicsScene::OpenSCADGraphicsScene(DataFlowGraphModel &graphModel, QObject *parent)
...
std::vector<NodeId> OpenSCADGraphicsScene::selectedNodes() const
{
...
void
OpenSCADGraphicsScene::setGraphModel(DataFlowGraphModel & model)
{
    _graphModel = model;
    Q_EMIT sceneLoaded();
}
